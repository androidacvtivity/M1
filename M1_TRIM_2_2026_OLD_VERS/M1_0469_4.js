        ...
        attach: function (context, settings) {
            ...
            jQuery('#mywebform-edit-form', context).on('paste', 'input.numeric, input.money, input.float', function (event) {
                ...
                if (typeof obj.clipboardData !== 'undefined') {
                    ...
                    if (!isNumeric || isNaN(number) || is_negative(number)) {  // Prevent invalid number or negati
                        event.preventDefault();
            ...
            if (CAP1_R30 > 0) {
                ...
                if ((calcul2 < 5500) || (calcul2 > 20000)) {
                    webform.warnings.push({
                        'fieldName': 'CAP1_R70_C' + arr_CAP1_inputs_2[i],
                        'weight': 36,
                        'msg': Drupal.t('Cod atenționare: 05-036 - Cap.1: (R.70 - R.73 * 1000 / R.30) / 3 > 5500 și < 20000 pe fiecare coloană. -> [@sum]', { '@sum': calcul2 })
                    });
                }
            }
            // End 05-036
            ...
            if (CAP1_R40 > 0) {
                ...
                if ((calcul4 < 5500) || (calcul4 > 20000)) {
                    webform.warnings.push({
                        'fieldName': 'CAP1_R73_C' + arr_CAP1_inputs_2[i],
                        'weight': 39,
                        'msg': Drupal.t('Cod atenționare: 05-039 - Cap. 1: (R.73 * 1000 / R.40) / 3 > 5500 și < 20000 pe fiecare coloană. -> [@sum]', { '@sum': calcul4 })
                    });
                }
            }
            // End 05-039
        ...
        if (valid_ == 1) {
            ...
            for (var i = 0; i < arr_CAP2_inputs_2.length; i++) {
                ...
                if (CAP2_R10 > 0) {
                    ...
                    // Calculul valorii minime posibile pentru R.160
                    var min_CAP2_R20 = 0 * CAP2_R20;
                    var min_CAP2_R30 = 6300 * CAP2_R30;
                    var min_CAP2_R40 = 6300 * CAP2_R40;
                    var min_CAP2_R50 = 7000 * CAP2_R50;
                    var min_CAP2_R60 = 8000 * CAP2_R60;
                    var min_CAP2_R70 = 10000 * CAP2_R70;
                    var min_CAP2_R80 = 15000 * CAP2_R80;
                    var min_CAP2_R90 = 20000 * CAP2_R90;
                    var min_CAP2_R100 = 25000 * CAP2_R100;
                    var min_CAP2_R110 = 30000 * CAP2_R110;
                    ...
                    // Calculul valorii maxime posibile pentru R.160
                    var max_CAP2_R20 = 6300 * CAP2_R20;
                    var max_CAP2_R30 = 6300 * CAP2_R30;
                    var max_CAP2_R40 = 7000 * CAP2_R40;
                    var max_CAP2_R50 = 8000 * CAP2_R50;
                    var max_CAP2_R60 = 10000 * CAP2_R60;
                    var max_CAP2_R70 = 15000 * CAP2_R70;
                    var max_CAP2_R80 = 20000 * CAP2_R80;
                    var max_CAP2_R90 = 25000 * CAP2_R90;
                    var max_CAP2_R100 = 30000 * CAP2_R100;

                    /*
                     * R.110 reprezintă salarii peste 30000 lei.
                     * Pentru verificarea la maximum se folosește limita convențională
                     * de 40000 lei, conform logicii existente a validării.
                     */
                    var max_CAP2_R110 = 40000 * CAP2_R110;
                    ...
                    if (
                        CAP2_R160 < min_CAP2_R160 ||
                        CAP2_R160 > max_CAP2_R160
                    ) {
                        webform.warnings.push({
                            'fieldName': 'CAP2_R160_C' + arr_CAP2_inputs_2[i],
                            'weight': 9,
